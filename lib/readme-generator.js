...
>
> **Count Contract**
> - **R2 feed rows**: ${feedCount ?? 'unknown'}
> - **current_jobs.json rows**: ${currentJobsCount}
> - **README post-filter rows**: ${readmePostFilterCount}
> - **Displayed table rows**: ${displayedRowCount}
> - **Companies shown**: ${totalCompanies}
> - **Generated at**: ${countTimestamp}
