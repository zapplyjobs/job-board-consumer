    ...
    Object.entries(jobCategories).forEach(([categoryKey, categoryData]) => {
      ...
      finalJobs.forEach((job) => {
        ...
        if (showVisaColumn) {
          ...
          const visa = (sponsorsVisa || visaQuestion || possibleSponsor) ? "✅ Sponsor" : "";
          output += `| ${emoji} **${companyName}** | ${role} | ${location} | ${posted} | ${visa} | [<img src="images/apply.png" width="120" alt="Apply">](${applyLink}) |\n`;
        } else {
          output += `| ${emoji} **${companyName}** | ${role} | ${location} | ${posted} | [<img src="images/apply.png" width="120" alt="Apply">](${applyLink}) |\n`;
        }
      });
